...
# ====== CONFIGURAÇÃO ======
QUERY_LOG_PATH = "./.claude/logs/rag-queries.jsonl"  # JSONL = JSON Lines
FEEDBACK_LOG_PATH = "./.claude/logs/rag-feedback.jsonl"
ANALYTICS_PATH = "./.claude/logs/rag-analytics.json"
