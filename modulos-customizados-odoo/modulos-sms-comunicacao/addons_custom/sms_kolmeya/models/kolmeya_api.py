...
class KolmeyaAPI:
    ...
    def get_balance(self):
        ...
        Returns:
            dict: Balance information with 'saldo' (balance in R$ as float)
        """
        response = self._make_request('/sms/balance')
        
        # API retorna {"balance": "R$9.396,84"} - precisamos converter para float
        ...
        # Retorna no formato esperado pelo resto do código
        return {
            'saldo': balance_float,
