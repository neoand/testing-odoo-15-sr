...
{
    'name': 'ChatRoom SEND Helpdesk Ticket and Templates. WhatsApp.',
    'summary': 'Send messages from Helpdesk Ticket with Templates.',
    'description': 'Send Helpdesk Ticket. Real All in One. Send and receive messages. Real ChatRoom. '
