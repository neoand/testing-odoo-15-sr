...
# =====================================================================================
{
    'name': 'ChatRoom users access HelpDesk',
    'summary': 'Restrict user access to HelpDesk Team. ChatRoom 2.0.',
    'description': 'Restrict user access to HelpDesk Team. WhatsApp integration. WhatsApp Connector. GupShup. Chat-Api. ChatApi. ChatRoom 2.0.',
    'version': '15.0.1',
    'author': 'AcruxLab',
