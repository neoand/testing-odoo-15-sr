...
# =====================================================================================
{
    'name': 'ChatRoom Audio Recorder WhatsApp',
    'summary': 'Live Audio Recorder in ChatRoom. ChatRoom 2.0.',
    'description': 'Live Audio Recorder in ChatRoom. ChatRoom 2.0.',
    'version': '15.0.1',
    'author': 'AcruxLab',
    ...
    'assets': {
        'web.assets_backend': [
            '/whatsapp_connector_audio_record/static/src/css/*.css',
            '/whatsapp_connector_audio_record/static/src/js/*.js',
        ],
        'web.assets_qweb': [
            'whatsapp_connector_audio_record/static/src/xml/*',
        ],
    },
    'post_load': '',
