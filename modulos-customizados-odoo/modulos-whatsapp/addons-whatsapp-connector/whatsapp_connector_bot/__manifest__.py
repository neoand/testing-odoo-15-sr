...
# =====================================================================================
{
    ...
    'summary': 'Chat Bot. Automatic messages for product and text. Templates and Python code. '
               'WhatsApp ChatBot integration. ChatBot WhatsApp bot apichat.io GupShup Chat-Api ChatApi. ChatRoom 2.0.',
    'description': 'BOT WhatsApp Automatic messages for product and free text. Templates and Python code. '
