...
{
    'name': 'ChatRoom SEND Product and Stock Picking. Templates. WhatsApp',
    'summary': 'Send messages from Product and Stock Picking with Templates.',
    'description': 'Send Product and Stock Picking (In, Out, Internal Transfer, Returns). Product Templates. '
                   'Real All in One. Send and receive messages. Real ChatRoom. WhatsApp integration. '
                   'WhatsApp Connector. apichat.io. GupShup. Chat-Api. ChatApi. Drag and Drop.',
    'version': '15.0.1',
    'author': 'AcruxLab',
