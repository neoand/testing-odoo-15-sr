...
# =====================================================================================
{
    'name': 'WhatsApp Product Option. ChatRoom',
    'summary': 'Send dynamic Product message from ChatRoom. WhatsApp integration. WhatsApp Connector. GupShup. Chat-Api. ChatApi. ChatRoom 2.0.',
    'description': 'Send dynamic Product message from ChatRoom. WhatsApp integration. WhatsApp Connector. GupShup. Chat-Api. ChatApi. ChatRoom 2.0.',
    'version': '15.0.2',
    'author': 'AcruxLab',
    ...
    'assets': {
        'web.assets_backend': [
            '/whatsapp_connector_product_option/static/src/js/*.js',
        ],
        'web.assets_qweb': [
            '/whatsapp_connector_product_option/static/src/xml/*',
        ],
    },
    'post_load': '',
