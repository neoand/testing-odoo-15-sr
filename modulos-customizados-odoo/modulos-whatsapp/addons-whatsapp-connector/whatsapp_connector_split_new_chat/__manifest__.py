...
# =====================================================================================
{
    'name': 'WhatsApp Split chats. ChatRoom',
    'summary': 'Split new chats into mine or all. WhatsApp integration. WhatsApp Connector. GupShup. Chat-Api. ChatApi. ChatRoom 2.0.',
    'description': 'Split new chats into mine or all. WhatsApp integration. WhatsApp Connector. GupShup. Chat-Api. ChatApi. ChatRoom 2.0.',
    'version': '15.0.2',
    'author': 'AcruxLab',
    ...
    'assets': {
        'web.assets_backend': [
            '/whatsapp_connector_split_new_chat/static/src/js/*.js',
        ],
        'web.assets_qweb': [
            '/whatsapp_connector_split_new_chat/static/src/xml/*',
        ],
    },
    'post_load': '',
