...
{
    'name': 'ChatRoom SEND Subscription and Templates. WhatsApp.',
    'summary': 'Send messages from Subscription with Templates.',
    'description': 'Send Subscription. Real All in One. Send and receive messages. Real ChatRoom. '
