...
{
    'name': 'ChatRoom SEND Repair Orders and Templates. WhatsApp.',
    'summary': 'Send messages from Repair Orders with Templates.',
    'description': 'Send Repair Orders. Real All in One. Send and receive messages. Real ChatRoom. '
