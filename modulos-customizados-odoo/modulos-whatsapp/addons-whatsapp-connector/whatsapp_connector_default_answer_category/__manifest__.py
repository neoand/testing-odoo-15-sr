...
# =====================================================================================
{
    'name': 'ChatRoom Advanced Default Answer. Real All in One',
    'summary': 'Edit Default Answer Before Send. Categories. ChatRoom 2.0.',
    'description': 'Edit Default Answer Before Send. Categories. ChatRoom 2.0.',
    'version': '15.0.7',
    'author': 'AcruxLab',
    ...
    'price': 150.0,
    'currency': 'USD',
    # 'images': ['static/description/Banner_facebook_v7.gif'],
    ...
    'data': [
        ...
        'views/default_answer_category_views.xml',
        'views/default_answer_views.xml',
        'views/menu.xml',
    ],
    'assets': {
        'web.assets_backend': [
            'whatsapp_connector_default_answer_category/static/src/js/*.js',
        ]
    },
    'qweb': [
    ],
