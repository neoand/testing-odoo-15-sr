...
# =====================================================================================
{
    'name': 'ChatRoom users access CRM',
    'summary': 'Restrict user access to CRM Team. ChatRoom 2.0.',
    'description': 'Restrict user access to CRM Team, Conversation and CRM Team. WhatsApp integration. WhatsApp Connector. GupShup. Chat-Api. ChatApi. ChatRoom 2.0.',
    'version': '15.0.1',
    'author': 'AcruxLab',
