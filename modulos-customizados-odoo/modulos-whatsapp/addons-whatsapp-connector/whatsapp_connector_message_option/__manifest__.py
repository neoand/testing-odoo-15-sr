...
# =====================================================================================
{
    'name': 'WhatsApp Message Option. ChatRoom',
    'summary': 'Quote and Delete messages in ChatRoom.',
    'description': 'Quote and Delete messages in ChatRoom.',
    'version': '15.0.7',
    'author': 'AcruxLab',
    ...
    'assets': {
        'web.assets_backend': [
            # widgets
            '/whatsapp_connector_message_option/static/src/js/acrux_*.js',
            '/whatsapp_connector_message_option/static/src/css/acrux_chat.css',
        ],
        'web.assets_qweb': [
            'whatsapp_connector_message_option/static/src/xml/*',
        ],
    },
    'post_load': '',
