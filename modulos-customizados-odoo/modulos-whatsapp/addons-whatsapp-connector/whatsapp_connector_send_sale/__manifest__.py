...
{
    'name': 'ChatRoom SEND Sale Order and Templates. WhatsApp',
    'summary': 'Send messages from Sale Order with Templates.',
    'description': 'Send Sales Orders. Sale Templates. Real All in One. Send and receive messages. Real ChatRoom. '
